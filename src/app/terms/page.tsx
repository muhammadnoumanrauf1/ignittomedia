  ...
  return (
    <div className="relative w-full bg-brand-bg min-h-screen font-sans selection:bg-white/20 overflow-x-hidden">
      ...
      <main className="relative z-10 w-full max-w-4xl mx-auto px-6 pt-40 pb-32 bg-brand-bg text-white border-b border-white/10 shadow-2xl rounded-b-[40px] md:rounded-b-[80px] text-left">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-wide mb-8 text-white text-glow">Terms of Service</h1>
        
        <div className="space-y-6 text-brand-text-secondary leading-relaxed font-light">
          <p>Last updated: {new Date().toLocaleDateString()}</p>
          
          <h2 className="text-2xl font-bold tracking-wide text-white mt-12 mb-4">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-2xl font-bold tracking-wide text-white mt-12 mb-4">2. Services Provided</h2>
          ...
          <h2 className="text-2xl font-bold tracking-wide text-white mt-12 mb-4">3. Intellectual Property</h2>
          ...
          <h2 className="text-2xl font-bold tracking-wide text-white mt-12 mb-4">4. Limitation of Liability</h2>
