  ...
  return (
    <div className="relative w-full bg-brand-bg min-h-screen font-sans selection:bg-white/20 overflow-x-hidden">
      ...
      <main className="relative z-10 w-full max-w-4xl mx-auto px-6 pt-40 pb-32 bg-brand-bg text-white border-b border-white/10 shadow-2xl rounded-b-[40px] md:rounded-b-[80px] text-left">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-white text-glow">Refund Policy</h1>
        
        <div className="space-y-6 text-brand-text-secondary leading-relaxed">
          <p>Last updated: {new Date().toLocaleDateString()}</p>
          
          <h2 className="text-2xl font-semibold text-white mt-12 mb-4">1. General Policy</h2>
          ...
          <h2 className="text-2xl font-semibold text-white mt-12 mb-4">2. Revisions and Adjustments</h2>
          ...
          <h2 className="text-2xl font-semibold text-white mt-12 mb-4">3. Exceptional Circumstances</h2>
