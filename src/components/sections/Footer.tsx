  ...
  return (
    <footer className="bg-[#010B14] py-16 px-6 border-t border-white/5 relative z-10">
      <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-8 md:gap-6">
        ...
        <nav className="flex flex-wrap justify-center items-center gap-x-8 gap-y-4 text-sm font-medium text-brand-text-muted">
        ...
        <div className="flex items-center gap-6 text-sm">
          <a href="mailto:info@ignittomedia.com" aria-label="Email" className="text-brand-text-muted hover:text-brand-glow transition-colors interactive">
            <Mail className="w-5 h-5" />
          </a>
          <a href="https://www.instagram.com/ignittomedia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-brand-text-muted hover:text-brand-glow transition-colors interactive">
          ...
          <a href="https://www.facebook.com/ignittomedia" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-brand-text-muted hover:text-brand-glow transition-colors interactive">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
              <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
            </svg>
          </a>
          <a href="https://www.linkedin.com/company/ignitto-media" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-brand-text-muted hover:text-brand-glow transition-colors interactive">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
      ...
      <div className="max-w-7xl mx-auto w-full mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-brand-text-muted/60">
