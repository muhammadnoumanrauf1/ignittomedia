  ...
  return (
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform transform-style-3d">
        <h1 className="text-track gsap-reveal text-3d-matte text-5xl md:text-7xl lg:text-[7rem] font-bold tracking-tight mb-2 leading-none">
          {tagline1}
        </h1>
        <h1 className="text-days gsap-reveal text-silver-matte text-5xl md:text-7xl lg:text-[7rem] font-extrabold tracking-tighter leading-none pb-2">
          {tagline2}
        </h1>
      </div>
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal will-change-transform">
        ...
        <h2 className="text-5xl md:text-7xl lg:text-[6rem] font-bold mb-6 tracking-tight text-silver-matte">
          {ctaHeading}
        </h2>
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-6xl mx-auto px-4 lg:px-12 flex flex-col justify-center items-center z-10 py-6 lg:py-0 gap-8">
            ...
            {/* 1. TOP TEXT */}
            <div className="card-top-text gsap-reveal flex justify-center text-center z-20 w-full absolute top-24 md:top-32 px-4">
            ...
            {/* 3. BOTTOM TEXT */}
            <div className="card-bottom-text gsap-reveal flex justify-center text-center z-20 w-full absolute bottom-12 md:bottom-24 px-4">
