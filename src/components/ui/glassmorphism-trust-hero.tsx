  ...
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans">
      ...
      */}
      ...
      <div 
        className="absolute inset-0 z-0 bg-[url(https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2000&auto=format&fit=crop)] bg-cover bg-center opacity-40"
        style={{
